...
Где notNews - задача 2: массив с идентификаторами новостей, которые не являются новостью;
wrongTopic - задача 3: массив с идентификаторами новостей, отнесенных к неправильной теме;
dublicates - задача 4: массив с массивами, содержащими идентификаторы новостей об одном событии, где каждый вложенный массив относится к своему событию

📎 Примечания:
 • Не изменяй id новостей.
 • Если новость нельзя отнести ни к одной теме, то помещай ее в массив "notNews"
 • Максимальная строгость к фильтрации: лучше меньше, но точнее.`;
